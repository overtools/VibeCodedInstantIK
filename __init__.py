...
class SNA_PT_OW_IK__SXLAR3D_AAF64(bpy.types.Panel):
    bl_label = 'Ow Ik - Sxlar3d'
    bl_idname = 'SNA_PT_OW_IK__SXLAR3D_AAF64'
    ...
    def draw(self, context):
        ...
        op = layout.operator('sna.create_orisa_rig_6b0f4', text='Orisa Ik Rig', icon_value=0, emboss=True, depress=False)
        op = layout.operator('sna.create_junkrat_rig_af672', text='Junkrat Ik Rig', icon_value=0, emboss=True, depress=False)
...
def register():
    ...
    bpy.utils.register_class(SNA_PT_OW_IK__SXLAR3D_AAF64)
...
def unregister():
    ...
    bpy.utils.unregister_class(SNA_PT_OW_IK__SXLAR3D_AAF64)
